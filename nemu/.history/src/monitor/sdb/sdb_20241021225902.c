...
static struct {
  ...
  {"x","Calculate the value of the expression `EXPR`, and use the result as the starting memory address to output `N` consecutive 4-byte values in hexadecimal format.",cmd_x}
